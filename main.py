...
def generate_post(news):
    ...
    body = {
        "model": "gpt-3.5-turbo",
        "messages": [
            {"role": "system", "content": "Ты — живой редактор новостей по ИИ с юмором, как будто болтаешь с друзьями. Строго следуй формату, зашивай ссылку в предложение, генерируй естественный, человеческий юмор в P.S."},
...
# ============================
# MAIN с расписанием (три раза в час, круглосуточно 365 дней)
# ============================
def main():
    # Установка расписания: три раза в час — в 00, 20 и 40 минуты каждого часа, без выходных и праздников
    schedule.every().hour.at(":00").do(job)
    schedule.every().hour.at(":20").do(job)
    schedule.every().hour.at(":40").do(job)

    print("[INFO] Бот запущен. Постинг три раза в час (в 00, 20 и 40 минуты) круглосуточно, 365 дней в году.")
    while True:
